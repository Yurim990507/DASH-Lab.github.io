...
<div  class="row center">
	...
	<div align="center" style="background: rgba(255, 255, 255, 0.315);padding:0; margin: auto; height: 620px; width: 800px; border-radius: 8px;" class="flickity carousel" data-flickity='{ "autoPlay": true }'>
			...
			<div class="gallery-cell" style="margin: auto; padding:0">
				<img  loading="lazy" class="carousel-cell" border=0  width=350 height=420   style=" border-radius: 8px;" src="/img/PAKDD_24-2.jpg"/>
				<p>Binh & Simon @PAKDD (Taiwan, May 2024)</p>			
			</div>
			<div class="gallery-cell" style="margin: auto; padding:0">
				<img  loading="lazy" class="carousel-cell" border=0  width=430 height=300   style=" border-radius: 8px;" src="/img/PAKDD 2024_travelaward.png"/>

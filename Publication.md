        ...
        <div style="margin-left: 25px;margin-right: 10px;">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <p style="margin-top: 0px;margin-bottom: 0px;text-align: justify;margin-left: 20px;"> <small> <a href="https://steel.isi.edu/members/rajattan/Rajat%20Tandon_files/CIKM2022_YouTube.pdf"> <img  alt="paper" src="paper_grey.svg" style="right: 15px; position:relative; top:5px; width: 18px; height: 18px;"> </a> &nbsp; <a
        ...
        <div style="margin-left: 25px;margin-right: 10px;">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <p style="margin-top: 0px;margin-bottom: 0px;text-align: justify;margin-left: 20px;"> <small><a href="https://arxiv.org/pdf/2208.11264.pdf"> <img  alt="paper" src="paper_grey.svg" style="right: 15px; position:relative; top:5px; width: 18px; height: 18px;"> </a> &nbsp;  <a

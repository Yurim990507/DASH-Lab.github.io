...
<div class="section">
  ...
  <p> Hyeon Seong Jeon, Young Oh Bang, and Simon S. Woo*, <strong>“FDFtNet: Facing Off Fake Images using Fake DetectionFine-tuning Network”,</strong> SEC 2020 International Conference on Information Security and Privacy Protection (IFIP-SEC), Solvenia, Sept 2020 (BK CS IF=1) <a href="../../tree/master/Publications/IFIP_SEC_2020_CR_paper_135.pdf" download> (PDF) </a> 
[get the PDF]({{ "../../tree/master/Publications/IFIP_SEC_2020_CR_paper_135.pdf" | absolute_url }}) </p>  
